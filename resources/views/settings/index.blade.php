            ...
            <div class="col-md-5 col-xl-4">
                ...
                <div class="card">
                    ...
                    <div class="list-group list-group-flush" role="tablist">
                        ...
                        @if($user->subscribed('Supplier Monthly Plan - SmokeDrop') || $user->onGenericTrial())
                        ...
                        @if($user->subscribed('Supplier Monthly Plan - SmokeDrop'))
            ...
            <div class="col-md-7 col-xl-8">
                ...
                <div class="tab-content">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <table class="table data-thumb-view p-0">
                                            ...
                                            <tbody>
                                            @foreach($user->subscriptions as $index => $s)
                                                <tr>
                                                    <td>{{$s->name}}</td>
                                                    <td>
                                                    ...
                                                    <td>$49.00</td>
                                                    <td>{{date_create($s->created_at)->format('M d')}}</td>
                                                    <td>@if($s->ends_at != null){{date_create($s->ends_at)->format('M d')}} @else {{date_create($s->created_at)->add(new DateInterval('P30D'))->format('M d')}} @endif</td>
                                                    {{--                                                    <td><a href="/user/invoice/{{ $invoices[$index]->id }}">Download</a></td>--}}
                                                    <td><a target="_blank" href="{{ $user->invoices()[$index]->hosted_invoice_url }}">View Invoice</a></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
                    ...
                    <div class="tab-pane fade" id="store-prefer-tab" role="tabpanel">
                        ...
                        <div class="card">
                            <div class="card-body">
                                {{--                                <form id="restricted_store_form" action="{{route('settings.supplier.set.restrictions')}}" method="post">--}}
                                {{--                                    @csrf--}}
                                {{--                                    <ul class="list-unstyled mb-0">--}}
                                {{--                                        <li class="d-inline-block mr-2">--}}
                                {{--                                            <fieldset>--}}
                                {{--                                                <div class="vs-radio-con">--}}
                                {{--                                                    <input required type="radio" class="prefer-radio" name="selection" @if(count($user->restricted_stores) == 0) checked="" @endif value="all">--}}
                                {{--                                                    <span class="vs-radio">--}}
                                ...
                                {{--                                            <fieldset>--}}
                                {{--                                                <div class="vs-radio-con">--}}
                                {{--                                                    <input required type="radio" class="prefer-radio" @if(count($user->restricted_stores) > 0) checked="" @endif name="selection" value="selected">--}}
                                {{--                                                    <span class="vs-radio">--}}
                                {{--                                                            <span class="vs-radio--border"></span>--}}
                                {{--                                                            <span class="vs-radio--circle"></span>--}}
                                {{--                                                        </span>--}}
                                {{--                                                    <span class="">Selected Stores</span>--}}
                                {{--                                                </div>--}}
                                {{--                                            </fieldset>--}}
                                {{--                                        </li>--}}
                                {{--                                    </ul>--}}
                                {{--                                    <div class="selected-stores" style="display: none;margin-left: 10px">--}}
                                {{--                                        <hr>--}}
                                {{--                                        @foreach($shops as $store)--}}
                                {{--                                            <fieldset>--}}
                                {{--                                                <div class="vs-checkbox-con vs-checkbox-primary">--}}
                                {{--                                                    <input type="checkbox" class="restricted_store"--}}
                                {{--                                                           @if(in_array($store->id,$user->restricted_stores->pluck('id')->toArray())) checked @endif--}}
                                {{--                                                           name="restricted[]" value="{{$store->id}}">--}}
                                {{--                                                    <span class="vs-checkbox">--}}
                                {{--                                                            <span class="vs-checkbox--check">--}}
                                {{--                                                                <i class="vs-icon feather icon-check"></i>--}}
                                {{--                                                            </span>--}}
                                {{--                                                        </span>--}}
                                {{--                                                    <span class="">{{$store->shopify_domain}}</span>--}}
                                {{--                                                </div>--}}
                                {{--                                            </fieldset>--}}
                                {{--                                        @endforeach--}}
                                ...
                                {{--                                    <button class="button-store-save text-white btn btn-primary">--}}
                                {{--                                        Save--}}
                                {{--                                    </button>--}}
                                {{--                                </div>--}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" readonly value="{{$user->referral_code}}">
                                    </div>
                                </div>
                                <hr>
                                <h6 class="mt-1">Referral Stores List</h6>
                                @if(count($user->restricted_stores) > 0)
                                    <table class="table data-thumb-view p-0">
                                        <tbody>
                                        @foreach($user->restricted_stores as $index => $s)
                                            <tr>
                                                <td>{{$s->shopify_domain}}</td>
                                                <td class="text-right"><i onclick="window.location.href='{{route('settings.detach.supplier.store',['supplier_id'=>$user->id,'store_id'=>$s->id])}}'" title="Detach Store" class="fa fa-trash font-medium-3" style="cursor: pointer"></i></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <form action="{{ route('supplier.shipping.settings') }}" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" required name="shipping_price" @if (isset($supplier_settings)) value="{{ $supplier_settings->shipping_price }}"
                                ...
                                <form action="{{ route('markup.settings') }}" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" required name="markup_value" @if (isset($markup_settings)) value="{{ $markup_settings->value }}"
                                                   @endif id="inputMarkupValue" placeholder="">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <select required class="form-control" name="markup_type"  id="inputMarkupType">
                                                ...
                                                <option value="percentage" @if(isset($markup_settings)) @if($markup_settings->type == 'percentage') selected @endif @endif>Percent</option>
                                                <option value="fixed" @if(isset($markup_settings)) @if($markup_settings->type == 'fixed') selected @endif @endif>Fixed</option>
                                                <option value="multiplier" @if(isset($markup_settings)) @if($markup_settings->type == 'multiplier') selected @endif @endif>Multiplier</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <input type="checkbox" name="ask_every_time" @if(isset($markup_settings)) @if($markup_settings->ask_every_time) checked
                    ...
                    <div class="tab-pane fade  " id="accounts-info-tab" role="tabpanel">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('settings.supplier.info.update')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="supplier_id" value="{{$user->id}}">
                                    <input type="hidden" name="type" value="user">
                                    <div class="form-group">
                                        <label for="email-account">Email</label>
                                        <input id="email-account" type="email" class="form-control" readonly value="{{$user->email}}">
                                    </div>

                                    <div class="form-group mt-2">
                                        <label for="username-account">User Name</label>
                                        <input id="username-account" name="name" type="text" class="form-control" value="{{$user->name}}">
                                    </div>
                                    <div class="form-group mt-2">
                                        <label for="username-account">Company Name</label>
                                        <input id="username-account" name="company_name" type="text" class="form-control" value="{{$user->company_name}}">
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('settings.supplier.password.update')}}" method="post">
                                    @csrf
                                    <input type="hidden" name="supplier_id" value="{{$user->id}}">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('settings.supplier.info.update')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input  name="address1" type="text" class="form-control" required value="{{$user->address}}">
                                    </div>

                                    <div class="form-group">
                                        <label>Address 2</label>
                                        <input name="address2" type="text" class="form-control" required value="{{$user->address2}}">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label >State</label>
                                                <input  name="state" type="text" class="form-control" required value="{{$user->state}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                        ...
                        @if(!$user->subscribed('Supplier Monthly Plan - SmokeDrop'))
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="monthly_subscribption_key" value="{{$monthly_subscribption_key}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" required class="form-control" id="cardAddress" placeholder="1234 Main St" name="address1"  value="{{$user->address}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputAddress2">Address 2</label>
                                        <input type="text" class="form-control" id="cardAddress2" name="address2" placeholder="Apartment, studio, or floor"  value="{{$user->address2}}">
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <label for="inputCity">City <span style="color: red">*</span></label>
                                            <input type="text" name="city" class="form-control"  value="{{$user->city}}" id="cardCity">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputState">State <span style="color: red">*</span></label>
                                            <input type="text" required name="state" class="form-control" id="cardState"  value="{{$user->state}}">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputCountry">Country <span style="color: red">*</span></label>
                                            <input type="text" required value="{{$user->country}}" name="country" class="form-control" id="cardCountry">
                                        </div>

                                        <button id="card-button" class="btn btn-primary" data-token="{{csrf_token()}}" data-method="post" data-route="{{route('settings.supplier.subscribe')}}" data-secret="{{ $intent->client_secret }}">
                                            Subscribe
                                        </button>
                                    </div>
                                </div>
                                @else
                                    <div class="card">
                                        <div class="card-body">
                                            @if ($user->subscription('Supplier Monthly Plan - SmokeDrop')->cancelled())
                                                <p class="mb-2">You Cancelled Monthly Supplier Subscription - $49.00 on card <span style="color: green">******{{$user->card_last_four}} </span> <br> you current subscription ends at {{date_create($user->subscription('Supplier Monthly Plan - SmokeDrop')->ends_at)->format('d M Y-H:i a')}}</p>
                                            @else
                                                <p class="mb-2">
                                                    You Subscribed Monthly Supplier Subscription - $49.00 on card <span style="color: green"> ******{{$user->card_last_four}} </span> <br>  {{date_create($user->subscription('Supplier Monthly Plan - SmokeDrop')->created_at)->format('d M Y-H:i a')}}
                                                    <br>

                                                    <span style="color: darkgrey;font-weight: 500">Next Transaction for Monthly Supplier Subscription - $49.00 on  {{date_create($user->subscription('Supplier Monthly Plan - SmokeDrop')->created_at)->add(new DateInterval('P30D'))->format('d M Y-H:i a')}} </span>
                                                    <br>
                                                </p>

                                            @endif
                                            @if (!$user->subscription('Supplier Monthly Plan - SmokeDrop')->cancelled())
                                                <button id="cancel-subscription" data-token="{{csrf_token()}}" data-action="cancel" data-route="{{route('settings.supplier.set.subscription')}}" class="btn btn-danger">
                                                    Cancel Subscription
                                                </button>
                                            @else
                                                <button id="resume-subscription" data-token="{{csrf_token()}}" data-action="resume" data-route="{{route('settings.supplier.set.subscription')}}"  class="btn btn-success">
                                                    Resume Subscription
                                                </button>
                                            @endif
                                        </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="accounts-tab" role="tabpanel">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('retailer.account.update') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label for="inputName">Company Name</label>
                                        <input type="text" class="form-control" id="inputName" name="user_name" placeholder="Enter company name"
                                               value="{{ \Illuminate\Support\Facades\Auth::user()->user_name  }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail4">Email</label>
                                        <input type="email" class="form-control" id="inputEmail4" name="user_email" placeholder="Enter email"
                                               value="{{ \Illuminate\Support\Facades\Auth::user()->user_email  }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputDomain">Connected Shopify Store</label>
                                        <input type="text" class="form-control" readonly value="{{ \Illuminate\Support\Facades\Auth::user()->myshopify_domain }}" id="inputDomain" placeholder="Store">
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if(isset($payment_method))
                                    @foreach($payment_method as $index => $m)
                                    <div class="row py-1" style="font-size: 20px">
                                        ...
                                        <div class="col-4 text-right text-primary">
                                            <a data-toggle="modal" data-target="#deletePaymentMethodConfirmationModal{{$index}}" class="text-primary"><i class="fa fa-trash"></i></a>
                                            <!-- The Modal -->

                                        </div>
                                    </div>
                                    <div class="modal" id="deletePaymentMethodConfirmationModal{{$index}}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('remove.payment.method',$m->id) }}" class="btn btn-danger">Yes! Remove Payment Method</a>
                                                </div>
...
{{--                                @endif--}}
                    ...
                    <div class="tab-pane fade" id="reffer-supplier-tab" role="tabpanel">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" action="{{route('settings.supplier.set.restrictions')}}" method="post">
                                    <div class="row">
                    ...
                    <div class="tab-pane fade" id="transactions-tab" role="tabpanel">
                        ...
                        <div class="card">
                            <table class="table data-thumb-view p-0">
                                ...
                                $i = 0;
                                @endphp
                                @if(count(auth()->user()->retailer_orders) > 0)
                                    @foreach(auth()->user()->retailer_orders as $index => $order)
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="accounts-tab" role="tabpanel">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('settings.admin.info.update')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="admin_id" value="{{$user->id}}">
                                <div class="profile-img-container text-center">
                                    <img @if(auth()->user()->gender == null) src="{{ asset('images/portrait/small/avatar-s-11.jpg') }}" @else src="{{ asset(auth()->user()->gender) }}" @endif class="d-block rounded-circle img-border box-shadow-1" style="width: 100%;max-width: 150px; margin: 10px auto;" alt="Card image">
                                    <a class="text-white input-file-button btn btn-primary">Upload Photo</a>
                                </div>

                                <div class="form-group">
                                    <label for="email-account">Email</label>
                                    <input id="email-account" type="email" class="form-control" name="email" value="{{$user->email}}">
                                </div>
                                <div class="form-group mt-2">
                                    <label for="username-account">User Name</label>
                                    <input id="username-account" name="name" type="text" class="form-control" value="{{$user->name}}">
                                ...
                                <div class="form-group mt-2">
                                    <input id="admin-image" onchange="readURL(this);" style="display: none" name="profile" type="file" accept="image/*" class="form-control" value="{{$user->gender}}">
                                </div>
                                <button type="submit" class="btn btn-primary">Save</button>
                            </form>
                        </div>
    ...
    <div id="overlay" class="overlay" style="display: none">
        <img class="loading-image" src="{{ asset('images/830.gif') }}" alt="loading">
    </div>
@endsection
